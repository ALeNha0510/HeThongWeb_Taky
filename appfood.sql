...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 08, 2024 lúc 04:29 AM
...
(7, 'Ly thi hong', 'dhong312', '$2y$10$SRVbqXnn8Ewfi6xwgqUhDewRYprWWbaA82WZ7SFQeiPKYST8Z.mx2', 'hong@gmail.com', '1234574897', 'Ha Noi', '2024-04-07 02:58:38', '2024-04-07 02:58:38'),
(8, 'Phan Thi Chi', 'chi123', '$2y$10$9kis0YncZlRP4D1bZwQFaut/qM4AjyI4GluLnIvESJyRn84CTJtAG', 'chi@gmail.com', '0934234234', 'Ca Mau', '2024-04-07 03:26:16', '2024-04-07 03:26:16'),
(10, 'delete1', 'delete123', '$2y$10$G5Nq2jFavLJMl5nhNySv9enpWyZ7RBkAgk0bgMBUlG9sM3YUpMEpy', 'delete@gmail.com', '1111111111', 'delete', '2024-04-08 03:28:37', '2024-04-08 03:28:37'),
(11, 'delete2', 'delete234', '$2y$10$v3dcvwPx0IupanFiyA2B.eLK0xkvSWNjluDnMeMGHXKaaRUbwt40O', 'delete2@gmail.com', '4567345678', 'delete2', '2024-04-08 03:30:08', '2024-04-08 03:30:08');
...
CREATE TABLE `danhmuc` (
  ...
  `tendanhmuc` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `trungbay` (`id`, `masanpham`) VALUES
(11, 29),
(12, 35),
(13, 40);
...
CREATE TABLE `hinhanh` (
  `id` int(11) NOT NULL,
  `ten_hinh` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `url_hinh` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_unicode_ci;
...
INSERT INTO `hinhanh` (`id`, `ten_hinh`, `url_hinh`) VALUES
(1, 'Banh mi', 'Images/banhmi.png'),
(2, 'Chan ga xa tac', 'Images/changaxatac.png')
...
(1, 'Xiên bẩn gây hại cho sức khỏe như thế nào?', '', '196', 'Xien ban se gay ai chia cho nguoi an, neu bung yeu');
...
INSERT INTO `product` (`id`, `name_product`, `image_product`, `price_product`, `sale_product`, `sl_product`, `madanhmuc`, `info_product`) VALUES
